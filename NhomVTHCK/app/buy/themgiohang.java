...
import com.example.myapplication2.profile.EditProfileActivity;
import com.example.myapplication2.profile.profile;
import com.example.myapplication2.thanhcong.Themgiohangtc;
...
public class themgiohang extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_themgiohang, container, false);
        ...
        Button buyNowButton = view.findViewById(R.id.addcart);
        ...
        buyNowButton.setOnClickListener(v -> {
            ...
            // Hiển thị DialogFragment Themgiohangtc
            Themgiohangtc dialog = new Themgiohangtc();
            dialog.show(getParentFragmentManager(), "Themgiohangtc");

            // Kết thúc BottomSheetDialogFragment hiện tại
            dismiss();
        });
